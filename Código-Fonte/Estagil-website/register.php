  ...
  <div class="spacer">
    <div class="row register">
      <div class="col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 ">
        ...
        <textarea rows="1" class="form-control" placeholder="Address" name="form_message"></textarea>


          <label><input class="radio-button" type="radio" name="gender" value="male"> Masculino</label>
